...
# Pagination 1
pagination = driver.find_element('xpath', '//ul[contains(@class, "pagingElements")]')  # locating pagination bar
pages = pagination.find_elements('tag name', 'li')  # locating each page displayed in the pagination bar
