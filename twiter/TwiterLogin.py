...
login_box = driver.find_element('xpath', '//form[@action="/sessions"]')

# locating username and password inputs
username = login_box.find_element('xpath', './/input[@name="session[username_or_email]"]')
password = login_box.find_element('xpath', './/input[@name="session[password]"]')
...
login_button = driver.find_element('xpath', '//div[@role="button"]')
login_button.click()
